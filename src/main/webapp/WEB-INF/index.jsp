          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              ...
              <ul class="nav navbar-nav navbar-right">
              	<li><a href="<c:url value='/my_page' />" > <span class="glyphicon glyphicon-user" aria-hidden="true"></span></a></li>
              	<li><a href="#" id="logoutLink"><span class="glyphicon glyphicon-off" aria-hidden="true"></span></a></li>
              </ul>
